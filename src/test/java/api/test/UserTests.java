...
public class UserTests 
{
	...
	
	{
		...
		Response response = UserEndPoints.getUsers(this.userPayload.getUsername());
	...
	public void testUpdateUser()
	{
		...
		Response response = UserEndPoints.updateUsers(userPayload,this.userPayload.getUsername());
		...
		Response responseAfterUpdate = UserEndPoints.getUsers(this.userPayload.getUsername());
